...
# 遺伝的アルゴリズム
def genetic_algorithm(pop_size, gene_length, generations,crossover_rate=0.7, mutation_rate=0.01,indpb=0.01,tornsize=3,crossover='single'):
    start = time.time()
    ...
    for generation in range(generations):
        ...
        while len(new_population) < pop_size:
            parent1 = tournament_selection(population, fitness_scores,tournament_size=tornsize)
            parent2 = tournament_selection(population, fitness_scores,tournament_size=tornsize)
